		...
		<>
			...
			<div className="containerBottom">
				<div className="container-sm dt-bottom">
					<div className="btn btn-danger mb-3">Arrest warrants</div>
					<div className="dt-bottom-det">
						{post.arrest_warrants?.map((e, index) => (
							<span key={index}>
								<span className="fw-bold">
									Issuing country: {e.issuing_country_id}
								</span>
								<hr />
								<h3 className="text">CHARGED WITH:</h3>
