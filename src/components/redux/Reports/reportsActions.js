...
export const actionGetReports = () => {
	return (dispatch) => {
		axios
			.get(`https://"YOUR_API".mockapi.io/my-reports/reports`)
			.then((response) => {
...
export const actionAddReport = (report) => (dispatch) => {
	const addReportPromise = axios
		.post(`https://"YOUR_API".mockapi.io/my-reports/reports`, report)
		.then((response) => {
...
export const actionDeleteReport = (id) => (dispatch) => {
	const deleteReportPromise = axios
		.delete(`https://"YOUR_API".mockapi.io/my-reports/reports/${id}`)
		.then((response) => {
...
export const actionUpdateReport =
	...
	(dispatch) => {
		const updateReportPromise = axios
			.put(`https://"YOUR_API".mockapi.io/my-reports/reports/${id}`, {
				firstName,
				lastName,
				nationality,
				dateOfBirth,
